...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/avneet-singh-nijjer/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@avneetnijjer",
    icon: Instagram,
    url: "https://www.instagram.com/avneetnijjer/",
    color: "#E4405F",
    gradient: "from-[#833AB4] via-[#E4405F] to-[#FCAF45]"
  },
  {
    //Youtube change to a different social 
    name: "YouTube",
    displayName: "Youtube",
    subText: "@AvneetNijjer",
    icon: Youtube,
    url: "https://www.youtube.com/@avneetnijjer",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "@AvneetNijjer",
    icon: Github,
    url: "https://github.com/avneetnijjer",
    color: "#ffffff",
    gradient: "from-[#333] to-[#24292e]"
  },
  {
    // TikTok Icon change to a different social 
    name: "TikTok",
    displayName: "Tiktok",
    subText: "@avneetnijjer",
    ...
    url: "https://tiktok.com/@avneetnijjer",
    color: "black",
